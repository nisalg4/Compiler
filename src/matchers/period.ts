 ...
 * Punctuation Period (denoted by '.' ), will be recognized by this matcher and exports the matching charcode
*/

import { ASCII } from "../interfaces/ascii";

export const matchPeriod = (charCode: number) => charCode === ASCII.PERIOD;
